...
// 19. August 2013
//
// Using: Xilinx Vivado HLS 2013.4
//
...
void mersenne_twister(uint32_t seeds[624],
	...
	#pragma HLS resource core=RAM_1P metadata="-bus_bundle slv0" \
			variable=seeds
	...
	static hls::stream<uint32_t> fifo_227;
	static hls::stream<uint32_t> fifo_396;

	#pragma HLS stream depth=226 variable=fifo_227
	#pragma HLS stream depth=396 variable=fifo_396

	static uint32_t index_minus_0, index_minus_396, index_minus_397;
	static bool index_minus_396_valid = false;
	static bool index_minus_397_valid = false;
	static uint10_t cnt = 0;

	static uint32_t result_last;
